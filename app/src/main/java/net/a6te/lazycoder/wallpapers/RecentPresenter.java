...
public class RecentPresenter implements MVPPresenter.RecentlyPresenter {

    private net.a6te.lazycoder.wallpapers.MVP.MVPView.RecentView MVPView;
    private Context context;
    private WallpaperAdapter adapter;
    private ArrayList<Category> categories;
    private Fragment fragment;

    public RecentPresenter(Context context, Fragment fragment) {
        this.MVPView = (net.a6te.lazycoder.wallpapers.MVP.MVPView.RecentView) fragment;
