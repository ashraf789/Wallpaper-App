 ...
 */
public class Popular extends Fragment implements MVPView.PopularView, OnItemClick{

    private View rootView;
    private RecyclerView recyclerView;
    private Context context;
    private MVPPresenter.PopularPresenter presenter;
    ...
    private void initializeAll() {
        fragment = this;
        recyclerView = rootView.findViewById(R.id.popularRv);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new GridLayoutManager(context,1));
        presenter = new PopularPresenter(context,fragment);
    }
